...
function SimpleWriteRecord(result){
...
//поиск через панель навигации
$('button#SimpleSearch').on('click', async function (e) {
    var url = window.location.href.match(/^.*\//);
    var q = $('input#SimpleTextSearch').val();
